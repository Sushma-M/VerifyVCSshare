...
import com.verifyvcsshare.testdb1_query.service.Testdb1_queryQueryExecutorService;
...
@RestController(value = "Testdb1_query.QueryExecutionController")
@Api(value = "QueryExecutionController", description = "Controller class for query execution")
@RequestMapping("/testdb1_query/queryExecutor")
public class QueryExecutionController {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

    @Autowired
    private Testdb1_queryQueryExecutorService queryService;
