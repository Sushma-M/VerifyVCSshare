...
@Service
public class Testdb1_queryProcedureExecutorServiceImpl implements Testdb1_queryProcedureExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Testdb1_queryProcedureExecutorServiceImpl.class);

	@Autowired
	@Qualifier("testdb1_queryWMProcedureExecutor")
