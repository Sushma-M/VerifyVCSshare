 ...
 * @see Table1
 */
@Service("testdb1_query.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("testdb1_query.Table1Dao")
	...
	@Transactional(readOnly = true, value = "testdb1_queryTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "testdb1_queryTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service testdb1_query for table Table1 to {} format", exportType);
