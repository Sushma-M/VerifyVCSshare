...
@Service
public class Dbtest_sharedQueryExecutorServiceImpl implements Dbtest_sharedQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Dbtest_sharedQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("dbtest_sharedWMQueryExecutor")
