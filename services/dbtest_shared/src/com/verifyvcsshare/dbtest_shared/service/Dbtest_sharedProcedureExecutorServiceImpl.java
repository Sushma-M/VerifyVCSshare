...
@Service
public class Dbtest_sharedProcedureExecutorServiceImpl implements Dbtest_sharedProcedureExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Dbtest_sharedProcedureExecutorServiceImpl.class);

	@Autowired
	@Qualifier("dbtest_sharedWMProcedureExecutor")
