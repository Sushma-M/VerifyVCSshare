 ...
 * @see Table2
 */
@Service("dbtest_shared.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("dbtest_shared.Table2Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbtest_shared for table Table2 to {} format", exportType);
