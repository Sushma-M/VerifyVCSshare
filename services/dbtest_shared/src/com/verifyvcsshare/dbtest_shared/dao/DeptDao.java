...
/**
 * Specifies methods used to obtain and modify Dept related information
 * which is stored in the database.
 */
@Repository("dbtest_shared.DeptDao")
public class DeptDao extends WMGenericDaoImpl<Dept, Integer> {
