...
import com.verifyvcsshare.dbtest_shared.service.Dbtest_sharedQueryExecutorService;
...
@RestController(value = "Dbtest_shared.QueryExecutionController")
@Api(value = "QueryExecutionController", description = "Controller class for query execution")
@RequestMapping("/dbtest_shared/queryExecutor")
public class QueryExecutionController {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

    @Autowired
    private Dbtest_sharedQueryExecutorService queryService;
